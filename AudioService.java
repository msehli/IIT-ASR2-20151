...
public class AudioService extends Service {
    ...
    public static final int MEDIA_PLAYER_CONTROL_FINISH = 26;
    ...
    private void playMgs(){
        ...
        try {
            mMediaPlayer.setDataSource("/sdcard/Download/a.mp3");
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case AudioService.MEDIA_PLAYER_CONTROL_PROGRESS:
                    ...
                    int audioPosition = (int)((float)audioLength*(float)progress/100);
                   // if(audioPosition==100)
                    target.mMediaPlayer.seekTo(audioPosition);

                    break;
                case AudioService.MEDIA_PLAYER_CONTROL_FINISH:
                    int audioLength1 = target.mMediaPlayer.getDuration();
                    int progress1 = message.arg1;
                    int audioPosition1 = (int)((float)audioLength1*(float)progress1/100);
